    ...
    <>
        ...
        <div className="px-5 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {isOwner && (
                <p className="text-xs text-text-faint">ეს შენი ნაკვეთია</p>
              )}
            </div>
          </div>

          {/* Contact ღილაკი — მხოლოდ სხვისი ნაკვეთისთვის */}
          {!isOwner && (
            <div className="mt-4">
              {canContact ? (
                <button
                ...
                <div className="flex items-center gap-2 py-2.5 px-4 rounded-xl bg-background border border-border">
                  ...
                  <p className="text-sm text-text-faint">მფლობელმა საკონტაქტო ინფო არ გაასაჯაროვა</p>
                </div>
              )}
            </div>
          )}
      ...
      {showContact && (
        <ContactModal
          ownerId={owner.id}
          ownerName={ownerName}
          hasEmail={!!owner.show_email && !!owner.email}
