    ...
    <div className="space-y-2">
      <div className="bg-surface rounded-2xl border border-border p-4">
        <div className="flex flex-wrap gap-3 items-end">
          <div className="flex-[2] min-w-[180px]">
            <label className="block text-xs font-medium text-text-muted mb-1.5">{t("cadastralLabel")}</label>
            <div className="relative">
              ...
              <input type="text" value={values.cadastral} onChange={(e) => handleChange("cadastral", e.target.value)}
          ...
          <div className="flex-1 min-w-[140px]">
            <label className="block text-xs font-medium text-text-muted mb-1.5">{t("regionLabel")}</label>
            <div className="relative">
              <input type="text" value={values.region} onChange={(e) => handleChange("region", e.target.value)}
          ...
          <div className="flex-1 min-w-[140px]">
            <label className="block text-xs font-medium text-text-muted mb-1.5">{t("municipalityLabel")}</label>
            <div className="relative">
              <input type="text" value={values.municipality} onChange={(e) => handleChange("municipality", e.target.value)}
          ...
          <div className="flex items-end gap-2 pb-0">
            <button onClick={toggleMine}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium border transition-all ${
                mine ? "bg-primary text-white border-primary shadow-sm" : "bg-surface text-text-muted border-border hover:border-primary-muted hover:text-primary"
              }`}>
      ...
      {hasFilters && (
        <div className="flex items-center gap-2 flex-wrap px-1">
          <span className="text-xs text-text-faint">{t("filterPrefix")}</span>
          {mine && (
          ...
          <button onClick={clearAll} className="text-xs text-text-faint hover:text-danger transition-colors ml-1">
            {t("clearAll")}
          </button>
        </div>
      )}
