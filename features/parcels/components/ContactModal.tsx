...
export default function ContactModal({ ownerId, ownerName, onClose }: Props) {
  ...
  return (
    <div ref={backdropRef} onClick={handleBackdrop}
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm mb-0">
